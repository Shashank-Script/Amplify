      ...
      {Array.from({ length: _values.length }, (_, index) => (
        <SliderPrimitive.Thumb
          ...
          className={cn(
            ...
            color === "green" && "border-green-500 hover:ring-green-400/50 focus-visible:ring-green-400/50",
            color === "blue" && "border-blue-500 hover:ring-blue-400/50 focus-visible:ring-blue-400/50"
          )}
        />
      ))}
    </SliderPrimitive.Root>
